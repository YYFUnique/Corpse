...
// 	void SetWindowHasMaxBox(bool bHasMaxBox);
// 	bool IsWindowHasMaxBox();
...
// 	CStdString GetWindowShadowImage();
...
// 	const PTWindowShadowInfo GetShadowRect();
...
protected:
	...
	static void SaveListLabelElementProperty(CControlUI* pControl,TiXmlElement* pNode);
