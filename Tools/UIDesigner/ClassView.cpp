...
void CClassView::SetZipFileOutPath(LPCTSTR lpszZipFileOutPath)
{
	m_strZipFileOutPath = lpszZipFileOutPath;
}

LPCTSTR CClassView::GetZipFileOutPath()
{
	return m_strZipFileOutPath;
}

void CClassView::SetProjectPath(LPCTSTR lpszProjectPath)
{
	m_strProjectPath = lpszProjectPath;
}

LPCTSTR CClassView::GetProjectPath()
{
	return m_strProjectPath;
}

void CClassView::SetProjectName(LPCTSTR lpszProjectName)
{
	m_strProjectName = lpszProjectName;
}

LPCTSTR CClassView::GetProjectName()
{
