...
enum PropertyTag
{
	...
	//RichEdit
	tagRichEdit,
// 	tagRichEditNormalImage=tagRichEdit,
// 	tagRichEditHotImage,
// 	tagRichEditFocusedImage,
// 	tagRichEditDisableImage,
	tagRichEditVscrollbar=tagRichEdit,
	tagRichEditHscrollbar,
	tagRichEditWanttab,
	tagRichEditWantreturn,
	tagRichEditMultiline,
	tagRichEditReadonly,
	tagRichEditPassword,

	//Option
	tagOption,
	tagForeImage=tagOption,
	tagSelectedImage,
	tagSelectedHotImage,
	tagSelectedPressImage,
	tagSelected,
	tagGroup,
...
// 	tagThumbDisable,
	...
	//ListLabelElement
	tagListLabelElement,
	tagLabelHeight = tagListLabelElement,
	tagLabelSelected,

	//TabLayout
	tagTabLayout,
	tagSelectId=tagTabLayout,
};
...
protected:
	...
	void ShowTabLayoutProperty(CControlUI* pControl);
	void ShowTileLayoutProperty(CControlUI* pControl);
	void ShowListLabelElement(CControlUI* pControl);
protected:
