...
{
	CDialog::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_RICHEDIT, m_RichEditEx);
}
...
BEGIN_MESSAGE_MAP(CAnimatorDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDOK, &CAnimatorDlg::OnBnClickedOk)
END_MESSAGE_MAP()
...
void CAnimatorDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CAnimatorDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CAnimatorDlg::OnBnClickedOk()
{
	CFileDialog fd(TRUE);
	CString strFile;
	...
	if (ret == IDOK) {
		m_RichEditEx.InsertImage(strFile);
	}
}
