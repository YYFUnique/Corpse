...
// 
// std::wstring GetRichText(CRichEditUI* re)
// {
// 	std::wstring wstr;
...
// }
// 
// void InsertFaceToEdit(ui::CRichEdit* edit, const std::wstring &file_name, const std::wstring &tag)
// {
...
// 
// //处理可能内嵌的情况，"[[[大笑]"
// void _FindEmoji(ui::CRichEdit* edit, const std::wstring &str)
// {
// 	const wchar_t kCp = L'[';
// 
...
// 
// //表情格式 "[大笑]"
// void InsertTextToEdit(ui::CRichEdit* edit, const std::wstring &str)
// {
...
// }
// 
// void InsertImageToEdit(ui::CRichEdit* edit, const std::wstring& image_src, bool loading)
// {
// 	if (edit == NULL)
// 	{
// 		ASSERT(0);
...
// }
// 
// void InsertFileToEdit(ui::CRichEdit* edit, const std::wstring& file_path)
// {
