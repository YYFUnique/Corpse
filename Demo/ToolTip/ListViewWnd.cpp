...
LPCTSTR CListViewWnd::GetResourceID() const
{
...
void CListViewWnd::Add(const DESKTOP_INFO& DesktopInfo)
{
	...
	pFileItem->SetSubControlText(_T("searchitem_text"), DesktopInfo.strIconName);
}
