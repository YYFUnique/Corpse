...
LPCTSTR __className  =  _T("__IrregularWindowClass");
LPCTSTR __windowName =  _T("__IrregularWindow");

static HWND hAttackWnd = 0;
...
void CIrregularWindow::SetBackground(const TCHAR* pBackImgFullPath)
{
	...
	if(m_strBackImg.IsEmpty() == FALSE)
	{
		...
		::mbstowcs_s(&szHasConv,pImgPath,dwSize,m_strBackImg,m_strBackImg.size());
