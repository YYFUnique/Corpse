...
void CHardware::OnPaint()
{
	
}

void CHardware::SetFocus()
{
	if (m_hDevNotify != NULL)
		return;
...
BOOL CHardware::DeviceChanged(WPARAM wParam, LPARAM lParam)
{	
	...
	//设置变化类型
	CHardNotify::GetDeviceChangeEventTypeText(wParam, szEventInfo);
	...
	if (lpdb->dbch_devicetype == DBT_DEVTYP_DEVICEINTERFACE)
	{
		...
		CHardNotify::ConvertGuidToHardwareType(pDevInterface->dbcc_classguid, szInfo);
	...
	//设置此次变化的额外信息
	CHardNotify::GetDeviceEventText(wParam, lParam, szEventInfo);
