...
#include "../CdsObjects/CdsMediaClass.h"
...
#define MIMETYPE_VIDEO_TS			"video/vnd.dlna.mpeg-tts"
#define PROTINFO_VIDEO_TS			"http-get:*:video/vnd.dlna.mpeg-tts:DLNA.ORG_PN=MPEG_TS_SD_NA_ISO"
...
*/
char* FilePathToFileExtension(const char* file_path, int wide);
