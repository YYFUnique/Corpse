...
SPEC_API DWORD64 X64Call(DWORD64 func, int argC, ...);
SPEC_API DWORD64 GetModuleHandle64(wchar_t* lpModuleName);
SPEC_API DWORD64 GetProcAddress64(DWORD64 hModule, char* funcName);
SPEC_API SIZE_T VirtualQueryEx64(HANDLE hProcess, DWORD64 lpAddress, MEMORY_BASIC_INFORMATION64* lpBuffer, SIZE_T dwLength);
SPEC_API DWORD64 VirtualAllocEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flAllocationType, DWORD flProtect);
SPEC_API BOOL VirtualFreeEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD dwFreeType);
SPEC_API BOOL VirtualProtectEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flNewProtect, DWORD* lpflOldProtect);
SPEC_API BOOL ReadProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesRead);
SPEC_API BOOL WriteProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesWritten);
SPEC_API BOOL GetThreadContext64(HANDLE hThread, _CONTEXT64* lpContext);
SPEC_API BOOL SetThreadContext64(HANDLE hThread, _CONTEXT64* lpContext);
SPEC_API VOID SetLastErrorFromX64Call(DWORD64 status);
