...
typedef struct _ImageOle_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ImageOle_MIDL_TYPE_FORMAT_STRING;

typedef struct _ImageOle_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ImageOle_MIDL_PROC_FORMAT_STRING;

typedef struct _ImageOle_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ImageOle_MIDL_EXPR_FORMAT_STRING;
...
extern const ImageOle_MIDL_TYPE_FORMAT_STRING ImageOle__MIDL_TypeFormatString;
extern const ImageOle_MIDL_PROC_FORMAT_STRING ImageOle__MIDL_ProcFormatString;
extern const ImageOle_MIDL_EXPR_FORMAT_STRING ImageOle__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IRichEditImageOle_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IRichEditImageOle_ProxyInfo;
...
static const ImageOle_MIDL_PROC_FORMAT_STRING ImageOle__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ImageOle_MIDL_TYPE_FORMAT_STRING ImageOle__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    ImageOle__MIDL_ProcFormatString.Format,
...
/* Object interface: IRichEditImageOle, ver. 0.0,
   GUID={0xBEC6387B,0x2315,0x453D,{0x97,0x4D,0xBB,0x75,0xE6,0xC6,0xF7,0xAB}} */

#pragma code_seg(".orpc")
static const unsigned short IRichEditImageOle_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IRichEditImageOle_ProxyInfo =
    {
    &Object_StubDesc,
    ImageOle__MIDL_ProcFormatString.Format,
    &IRichEditImageOle_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IRichEditImageOle_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    ImageOle__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IRichEditImageOleProxyVtbl = 
{
    &IRichEditImageOle_ProxyInfo,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IRichEditImageOle::LoadFileFromPath */
};


static const PRPC_STUB_FUNCTION IRichEditImageOle_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IRichEditImageOleStubVtbl =
{
    &IID_IRichEditImageOle,
    &IRichEditImageOle_ServerInfo,
    8,
    &IRichEditImageOle_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ImageOle__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * _ImageOle_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IRichEditImageOleProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * _ImageOle_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IRichEditImageOleStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _ImageOle_InterfaceNamesList[] = 
{
    "IRichEditImageOle",
    "IComponentRegistrar",
    0
...
const IID *  _ImageOle_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _ImageOle_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _ImageOle, pIID, n)

int __stdcall _ImageOle_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _ImageOle, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _ImageOle, 2, *pIndex )
    
}

const ExtendedProxyFileInfo ImageOle_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _ImageOle_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ImageOle_StubVtblList,
    (const PCInterfaceName * ) & _ImageOle_InterfaceNamesList,
    (const IID ** ) & _ImageOle_BaseIIDList,
    & _ImageOle_IID_Lookup, 
    2,
    2,
