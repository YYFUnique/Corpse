...
LS_COMMON_API ULONG NTAPI RtlNtStatusToDosError(NTSTATUS);

LS_COMMON_API NTSTATUS WINAPI NtTerminateProcess(
								   IN HANDLE ProcessHandle OPTIONAL,
								   IN NTSTATUS ExitStatus);

LS_COMMON_API NTSTATUS WINAPI NtQuerySystemInformation (
						  IN SYSTEM_INFORMATION_CLASS SystemInformationClass,
						  OUT PVOID SystemInformation,
						  IN ULONG SystemInformationLength,
						  OUT PULONG ReturnLength OPTIONAL);

LS_COMMON_API NTSTATUS WINAPI NtQueryInformationThread(
...
LS_COMMON_API NTSTATUS WINAPI NtQueryInformationFile(
...
LS_COMMON_API NTSTATUS WINAPI NtQueryObject(
