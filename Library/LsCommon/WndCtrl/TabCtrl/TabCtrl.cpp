...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNCREATE(CTabCtrlEx,CWnd)
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// 
BOOL CTabCtrlEx::Create(LPCTSTR /*lpszClassName*/, LPCTSTR /*lpszWindowName*/, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* /*pContext*/)
{	return Create(pParentWnd,dwStyle,rect,nID)==true ? 1 : 0;
}
// 
bool CTabCtrlEx::Create(CWnd *parent, DWORD dwStyle, RECT const &rect, UINT nID)
{	CFont *font = CFont::FromHandle((HFONT)::GetStockObject(DEFAULT_GUI_FONT));
	if(GetFont()==NULL) SetFont(font);
	if(GetFontSelect()==NULL) SetFontSelect(font);
		// 
	CString sClass = Tools::RegisterWndClass(_T("CTabCtrlEx"),CS_DBLCLKS,::LoadCursor(NULL,IDC_ARROW),NULL,NULL);
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::OnActive(bool active, HWND /*wnd*/)	// ActivityHook::INotify.
{	if(active!=m_bActive)
	{	m_bActive = active;
		Invalidate(FALSE);
	}
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::WatchActivityCtrl(bool watch)
...
// 
bool CTabCtrlEx::IsWatchActivityCtrl() const
{	return m_bWatchActivityCtrl;
}
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::IsActive() const
{	return m_bActive;
}
/////////////////////////////////////////////////////////////////////////////
// 
HTAB CTabCtrlEx::Add(HWND wnd, TCHAR const *text, int image) throw(std::bad_alloc)
{	return Insert(m_vtrtabs.end(),wnd,text,image);
}
// 
HTAB CTabCtrlEx::Insert(HTAB hBefore, HWND wnd, TCHAR const *text, int image) throw(std::bad_alloc)
...
// 
HTAB CTabCtrlEx::Insert(m_i_vtrtabs before, HWND hWnd, TCHAR const *text, int image) throw(std::bad_alloc)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::RemoveBefore(HTAB hBefore, HTAB hSrc) throw(std::bad_alloc)
...
// 
void CTabCtrlEx::RemoveAfter(HTAB hAfter, HTAB hSrc) throw(std::bad_alloc)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::Delete(HTAB hTab)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetDrawManager(TabCtrlDraw *p)
{	m_pDrawManager = p;
}
// 
TabCtrlDraw *CTabCtrlEx::GetDrawManager() const
{	return m_pDrawManager;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetRecalcManager(ITabCtrlRecalc *p)
{	m_pRecalcManager = (p!=NULL ? p : &m_Service);
}
// 
ITabCtrlRecalc *CTabCtrlEx::GetRecalcManager() const
{	return m_pRecalcManager;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetBehaviorManager(ITabCtrlBehavior *p)
{	m_pBehaviorManager = (p!=NULL ? p : &m_Service);
}
// 
ITabCtrlBehavior *CTabCtrlEx::GetBehaviorManager() const
{	return m_pBehaviorManager;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetToolTipManager(ITabCtrlToolTip *p)
{	m_pToolTipManager = (p!=NULL ? p : &m_Service);
}
// 
ITabCtrlToolTip *CTabCtrlEx::GetToolTipManager() const
{	return m_pToolTipManager;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetAbilityManager(TabCtrlUserAbility *p)
{	m_pAbilityManager = (p!=NULL ? p : this);
}
// 
TabCtrlUserAbility *CTabCtrlEx::GetAbilityManager() const
{	return m_pAbilityManager;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetNotifyManager(TabCtrlNotify *p)
{	m_pNotifyManager = p;
}
// 
TabCtrlNotify *CTabCtrlEx::GetNotifyManager() const
{	return m_pNotifyManager;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetLayout(TAB_LAYOUT layout)
{	m_Layout = layout;
}
// 
TAB_LAYOUT CTabCtrlEx::GetLayout() const
{	return m_Layout;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetBehavior(TAB_BEHAVIOR behavior)
{	m_Behavior = behavior;
}
// 
TAB_BEHAVIOR CTabCtrlEx::GetBehavior() const
{	return m_Behavior;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::SetImageLists(CImageList *pImageList, CImageList *pImageListDisabled)
...
// 
void CTabCtrlEx::SetImageListsRef(CImageList *pImageList, CImageList *pImageListDisabled)
{	_ASSERTE(pImageList==NULL || pImageList->m_hImageList!=NULL);
	_ASSERTE(pImageListDisabled==NULL || pImageListDisabled->m_hImageList!=NULL);
		// 
	if(m_ImageList.m_hImageList!=NULL) m_ImageList.DeleteImageList();
...
// 
void CTabCtrlEx::GetImageLists(CImageList **pImageList/*out*/, CImageList **pImageListDisabled/*out*/)
{	if(pImageList!=NULL) *pImageList = m_pImageListRef;
	if(pImageListDisabled!=NULL) *pImageListDisabled = m_pImageListDisabledRef;
}
// 
void CTabCtrlEx::GetImageSizes(CSize *pszImage/*out*/, CSize *pszImageDisabled/*out*/) const
{	if(pszImage!=NULL)
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::SetSystemImageList(CImageList *pImageList)
{	_ASSERTE(pImageList==NULL || pImageList->m_hImageList!=NULL);
		// 
...
// 
void CTabCtrlEx::SetSystemImageListRef(CImageList *pImageList)
{	_ASSERTE(pImageList==NULL || pImageList->m_hImageList!=NULL);
		// 
	if(m_SysImageList.m_hImageList!=NULL) m_SysImageList.DeleteImageList();
...
// 
CImageList *CTabCtrlEx::GetSystemImageList() const
{	return m_pSysImageListRef;
}
// 
CSize CTabCtrlEx::GetSystemImageSize() const
{	return m_szSysImage;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::SetCursor(UINT uId)
{	return SetCursor(AfxGetResourceHandle(),uId);
}
// 
bool CTabCtrlEx::SetCursor(HMODULE hModule, UINT uId)
{	if(m_hCursor!=NULL)
...
// 
bool CTabCtrlEx::SetCursor(HCURSOR hCursor)
{	if(m_hCursor!=NULL)
	{	::DestroyCursor(m_hCursor);
		m_hCursor = NULL;
	}
...
// 
void CTabCtrlEx::SetCursorRef(HCURSOR *phCursor)
{	if(m_hCursor!=NULL)
	{	::DestroyCursor(m_hCursor);
		m_hCursor = NULL;
	}
...
// 
HCURSOR CTabCtrlEx::GetCursor() const
{	return (m_phCursorRef!=NULL ? *m_phCursorRef : NULL);
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::ShowBorder(bool show)
{	m_bShowBorder = show;
}
// 
bool CTabCtrlEx::IsShowBorder() const
{	return m_bShowBorder;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetTabText(HTAB hTab, TCHAR const *text) throw(std::bad_alloc)
{	_ASSERTE(IsExist(hTab)==true);
	_ASSERTE(text!=NULL);
		// 
...
// 
CString CTabCtrlEx::GetTabText(HTAB hTab) const
{	_ASSERTE(IsExist(hTab)==true);
		// 
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetTabImage(HTAB hTab, int image)
{	_ASSERTE(IsExist(hTab)==true);
	_ASSERTE(image>=-1);
	HNDLtoPTR(hTab)->image = image;
}
// 
int CTabCtrlEx::GetTabImage(HTAB hTab) const
{	_ASSERTE(IsExist(hTab)==true);
	return HNDLtoPTR(hTab)->image;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetTabWnd(HTAB hTab, HWND hWnd)
{	_ASSERTE(IsExist(hTab)==true);
	_ASSERTE(hWnd!=NULL && ::IsWindow(hWnd)!=0 && ::GetParent(hWnd)==m_hWnd);
...
// 
HWND CTabCtrlEx::GetTabWnd(HTAB hTab) const
{	_ASSERTE(IsExist(hTab)==true);
	return HNDLtoPTR(hTab)->hWnd;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetTabData(HTAB hTab, __int64 data)
{	_ASSERTE(IsExist(hTab)==true);
	HNDLtoPTR(hTab)->data = data;
}
// 
__int64 CTabCtrlEx::GetTabData(HTAB hTab) const
{	_ASSERTE(IsExist(hTab)==true);
...
// 
void CTabCtrlEx::CopyTab(HTAB hDst, CTabCtrlEx const *pTabCtrlSrc, HTAB hSrc) throw(std::bad_alloc)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetTabTooltipText(HTAB hTab, TCHAR const *text) throw(std::bad_alloc)
{	_ASSERTE(IsExist(hTab)==true);
	_ASSERTE(text!=NULL);
		// 
...
// 
CString CTabCtrlEx::GetTabTooltipText(HTAB hTab) const
{	_ASSERTE(IsExist(hTab)==true);
		// 
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetCloseButToolTipText(TCHAR const *text) throw(std::bad_alloc)
{	CSTRING_BAD_ALLOC( m_sToolTipButClose=text );
}
// 
CString CTabCtrlEx::GetCloseButToolTipText() const
{	return m_sToolTipButClose;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetMenuButToolTipText(TCHAR const *text) throw(std::bad_alloc)
{	CSTRING_BAD_ALLOC( m_sToolTipButMenu=text );
}
// 
CString CTabCtrlEx::GetMenuButToolTipText() const
{	return m_sToolTipButMenu;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetLeftScrollButToolTipText(TCHAR const *text) throw(std::bad_alloc)
{	CSTRING_BAD_ALLOC( m_sToolTipButLeftScroll=text );
}
// 
CString CTabCtrlEx::GetLeftScrollButToolTipText() const
{	return m_sToolTipButLeftScroll;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetRightScrollButToolTipText(TCHAR const *text) throw(std::bad_alloc)
{	CSTRING_BAD_ALLOC( m_sToolTipButRightScroll=text );
}
// 
CString CTabCtrlEx::GetRightScrollButToolTipText() const
{	return m_sToolTipButRightScroll;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::ToolTipEnable(bool enable)
{	m_bToolTipEnable = enable;
}
// 
bool CTabCtrlEx::IsToolTipEnable() const
{	return m_bToolTipEnable;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::Update(bool redraw)
{	Recalc(redraw);
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::InstallStyle(ITabCtrlStyle *style)
{	_ASSERTE(style!=NULL);
		// 
...
// Recalculate control.
// 
void CTabCtrlEx::Recalc(bool redraw)
...
/////////////////////////////////////////////////////////////////////////////
// 
int CTabCtrlEx::GetFullTabsWidth()
{	int width = 0;
		// 
	for(m_i_vtrtabs i=m_vtrtabs.begin(), e=m_vtrtabs.end(); i!=e; ++i)
		width += (*i)->width;
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::RecalcScale(int iVisibleTabsWidth, int iFullTabsWidth)
{	CRect rcTabHorzMargin = GetTabHorzMargin();
...
/////////////////////////////////////////////////////////////////////////////
// 
int CTabCtrlEx::CalcCtrlAreaHeight()
{	CClientDC dc(this);
...
/////////////////////////////////////////////////////////////////////////////
// 
int CTabCtrlEx::CalcTabWidth(HTAB hTab)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::TtnNeedText(NMTTDISPINFO *pTT)
{	m_sToolTip = _T("");
		// 
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::EqualTabsSize(bool equal)
{	m_bEqualTabsSize = equal;
}
// 
bool CTabCtrlEx::IsEqualTabsSize() const
{	return m_bEqualTabsSize;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::RemoveTabEnable(bool enable)
{	m_bRemoveTabEnable = enable;
}
// 
bool CTabCtrlEx::IsRemoveTabEnable() const
{	return m_bRemoveTabEnable;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::HideSingleTab(bool hide)
{	m_bHideSingleTab = hide;
}
// 
bool CTabCtrlEx::IsHideSingleTab() const
{	return m_bHideSingleTab;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::ShowScrollButtons(bool show)
{	m_bShowScrollButtons = show;
}
// 
bool CTabCtrlEx::IsShowScrollButtons() const
{	return m_bShowScrollButtons;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::ShowMenuButton(bool show)
{	m_bShowMenuButton = show;
}
// 
bool CTabCtrlEx::IsShowMenuButton() const
{	return m_bShowMenuButton;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::ShowCloseButton(bool show)
{	m_bShowCloseButton = show;
}
// 
bool CTabCtrlEx::IsShowCloseButton() const
{	return m_bShowCloseButton;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::SetFont(CFont *pFont)
...
// 
bool CTabCtrlEx::SetFont(LOGFONT const *pLf)
{	_ASSERTE(pLf!=NULL);
		// 
...
// 
void CTabCtrlEx::SetFontRef(CFont *pFont)
{	_ASSERTE(pFont!=NULL && pFont->m_hObject!=NULL);
		// 
	if(m_Font.m_hObject!=NULL) m_Font.DeleteObject();
	m_pFontRef = pFont;
...
// 
CFont *CTabCtrlEx::GetFont()
{	return m_pFontRef;
}
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::SetFontSelect(CFont *pFont)
{	_ASSERTE(pFont!=NULL && pFont->m_hObject!=NULL);
		// 
	LOGFONT logfont;
	pFont->GetLogFont(&logfont);
...
// 
bool CTabCtrlEx::SetFontSelect(LOGFONT const *pLf)
{	_ASSERTE(pLf!=NULL);
		// 
...
// 
void CTabCtrlEx::SetFontSelectRef(CFont *pFont)
{	_ASSERTE(pFont!=NULL && pFont->m_hObject!=NULL);
		// 
	if(m_FontSelect.m_hObject!=NULL) m_FontSelect.DeleteObject();
...
// 
CFont *CTabCtrlEx::GetFontSelect()
{	return m_pFontSelectRef;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
int CTabCtrlEx::GetCount() const
{	return (int)m_vtrtabs.size();
}
/////////////////////////////////////////////////////////////////////////////
// 
HTAB CTabCtrlEx::GetTab(int idx) const
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetSel(HTAB hTab)
{	_ASSERTE(IsExist(hTab)==true);
		// 
...
// 
HTAB CTabCtrlEx::GetSel() const
{	return m_hCurTab;
}
/////////////////////////////////////////////////////////////////////////////
// 
HTAB CTabCtrlEx::GetHover() const
{	return (m_hHoverArea!=NULL && IsSystemButton(m_hHoverArea)==false ? m_hHoverArea : NULL);
}
/////////////////////////////////////////////////////////////////////////////
// 
HTAB CTabCtrlEx::GetPushed() const
{	return (m_hPushedArea!=NULL && IsSystemButton(m_hPushedArea)==false ? m_hPushedArea : NULL);
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::Disable(HTAB hTab, bool disable) const
{	_ASSERTE(IsExist(hTab)==true);
	HNDLtoPTR(hTab)->disable = disable;
}
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::IsDisable(HTAB hTab) const
{	_ASSERTE(IsExist(hTab)==true);
	return HNDLtoPTR(hTab)->disable;
}
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::EnsureVisible(HTAB hTab)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::ScrollToBegin()
{	if(m_Behavior==TAB_BEHAVIOR_SCROLL)
		m_iTabsOffset = 0;
}
// 
void CTabCtrlEx::ScrollToEnd()
{	if(m_Behavior==TAB_BEHAVIOR_SCROLL)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetScrollingStep(int step)
{	_ASSERTE(step>=1);
	m_iScrollingStep = step;
}
// 
int CTabCtrlEx::GetScrollingStep() const
{	return m_iScrollingStep;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
HTAB CTabCtrlEx::HitTest(CPoint point) const
{	return m_pBehaviorManager->HitTest((CTabCtrlEx *)this,(ITabCtrlBehavior *)&m_Service,point);
}
/////////////////////////////////////////////////////////////////////////////
// 
int CTabCtrlEx::GetIndex(HTAB hTab) const
{	for(m_ci_vtrtabs i=m_vtrtabs.begin(), e=m_vtrtabs.end(); i!=e; ++i)
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::IsExist(HTAB hTab) const
{	return GetIndex(hTab)!=-1;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::GetTabRect(HTAB hTab, RECT *rc/*out*/) const
{	_ASSERTE(IsExist(hTab)==true);
	*rc = HNDLtoPTR(hTab)->rc;
}
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::IsTabVisible(HTAB hTab, bool *partially/*out*/) const
{	_ASSERTE(IsExist(hTab)==true);
		// 
...
/////////////////////////////////////////////////////////////////////////////
// 
HTAB CTabCtrlEx::GetTabWithWindowID(int id) const
{	return GetTabWithWindowID(id,NULL);
}
// 
HTAB CTabCtrlEx::GetTabWithWindowID(int id, HTAB exceptTab) const
{	for(m_ci_vtrtabs i=m_vtrtabs.begin(), e=m_vtrtabs.end(); i!=e; ++i)
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::GetTabAndIndex(int id, HTAB *tab/*out*/, int *idx/*out*/) const
{	for(m_ci_vtrtabs i=m_vtrtabs.begin(), e=m_vtrtabs.end(); i!=e; ++i)
...
/////////////////////////////////////////////////////////////////////////////
// 
int CTabCtrlEx::CmpTabs(HTAB hTab1, HTAB hTab2) const
...
/////////////////////////////////////////////////////////////////////////////
// 
int CTabCtrlEx::Service::GetBorderWidth(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return 1;
}
// 
CRect CTabCtrlEx::Service::GetCtrlAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(3,1,3,2/*indent*/) : CRect(3,2/*indent*/,3,1));
}
// 
CRect CTabCtrlEx::Service::GetWndsAreaPadding(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(0,0,0,0);
}
// 
CRect CTabCtrlEx::Service::GetTabHorzMargin(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(0,0,0,0);
}
// 
CRect CTabCtrlEx::Service::GetTabPadding(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(5,2+1/*border*/,5,2+1/*border*/);
}
// 
int CTabCtrlEx::Service::GetTabImageTextGap(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return 3;
}
// 
int CTabCtrlEx::Service::GetTabExtraWidth(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/, HTAB /*hTab*/)
{	return 0;
}
// 
int CTabCtrlEx::Service::GetTabMinWidth(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
...
// 
CRect CTabCtrlEx::Service::GetCloseButtonHorzMargin(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(2,0,2,0);
}
// 
CRect CTabCtrlEx::Service::GetMenuButtonHorzMargin(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(8,0,0,0);
}
// 
CRect CTabCtrlEx::Service::GetLeftScrollButtonHorzMargin(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(8,0,0,0);
}
// 
CRect CTabCtrlEx::Service::GetRightScrollButtonHorzMargin(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(0,0,0,0);
}
/////////////////////////////////////////////////////////////////////////////
// 
HTAB CTabCtrlEx::Service::HitTest(CTabCtrlEx *pCtrl, ITabCtrlBehavior * /*base*/, CPoint point)	// get tab in the given point.
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::Service::SetCursor(CTabCtrlEx *pCtrl, ITabCtrlBehavior * /*base*/)
...
/////////////////////////////////////////////////////////////////////////////
// 
CToolTipCtrl *CTabCtrlEx::Service::CreateToolTip(CTabCtrlEx *pCtrl, ITabCtrlToolTip * /*base*/)
...
/////////////////////////////////////////////////////////////////////////////
// 
RECT CTabCtrlEx::GetCtrlArea() const
{	return m_rcCtrlArea;
}
// 
RECT CTabCtrlEx::GetTabsArea() const
{	return m_rcTabs;
}
// 
RECT CTabCtrlEx::GetWindowsArea() const
{	return m_rcWindows;
}
/////////////////////////////////////////////////////////////////////////////
// 
RECT CTabCtrlEx::GetCloseButtonRect() const
{	return m_rcCloseButton;
}
// 
RECT CTabCtrlEx::GetMenuButtonRect() const
{	return m_rcMenuButton;
}
// 
RECT CTabCtrlEx::GetScrollLeftRect() const
{	return m_rcScrollLeft;
}
// 
RECT CTabCtrlEx::GetScrollRightRect() const
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::AssignHoverArea(CPoint point)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::LButtonDown(CPoint point)
{	if(m_hHoverArea!=NULL)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::OnRButtonUp(UINT nFlags, CPoint point)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::OnKeyDown(UINT keyCode, UINT /*msgFlag*/)
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::StartDragging(CPoint point)
{	m_bTabDrag = true;
		// 
...
// 
void CTabCtrlEx::StopDragging(bool cancel)
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::IsDragging() const
{	return m_bTabDrag;
}
// 
void CTabCtrlEx::CancelDragging()
{	StopDragging(true);
}
/////////////////////////////////////////////////////////////////////////////
// 
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::StepLeft()
{	m_iTabsOffset -= m_iScrollingStep;
}
// 
void CTabCtrlEx::StepRight()
{	m_iTabsOffset += m_iScrollingStep;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// 
void CTabCtrlEx::SetFocusInChildWnd()
{	HTAB hTab = GetSel();
	if(hTab!=NULL)
	{	HWND hWnd = GetTabWnd(hTab);
...
/////////////////////////////////////////////////////////////////////////////
// 
BOOL CTabCtrlEx::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message)
{	if(m_pBehaviorManager->SetCursor((CTabCtrlEx *)this,(ITabCtrlBehavior *)&m_Service)==true)
		return TRUE;
		// 
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::IsSystemButton(HTAB hTab) const
{	return hTab==m_hButClose || hTab==m_hButMenu || hTab==m_hButLeftScroll || hTab==m_hButRightScroll;
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::SaveState(CWinApp *app, TCHAR const *section, TCHAR const *entry) const
...
// 
bool CTabCtrlEx::LoadState(CWinApp *app, TCHAR const *section, TCHAR const *entry)
{	_ASSERTE(app!=NULL && section!=NULL && entry!=NULL);
		//
	bool res = false;
	BYTE *pData = NULL;
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::LoadState(CArchive *ar)
{	try
	{	LoadStateInner(ar);
		return true;
	}
...
// 
bool CTabCtrlEx::SaveState(CArchive *ar) const
{	try
	{	SaveStateInner(ar);
		return true;
	}
...
/////////////////////////////////////////////////////////////////////////////
// 
bool CTabCtrlEx::LoadStateInner(CArchive *ar)
{	int count;
	*ar >> count;	// count tabs.
		// 
	...
	{	*ar >> id;
		...
		bool found = GetTabAndIndex(id,&hTab,&target);
			// 
		if(found==false)
		{	TRACE("Not found tab with control id=%d (CTabCtrlEx::LoadStateInner)",id);
			return false;
		}
			// 
		if(i!=count-1)
...
// 
void CTabCtrlEx::SaveStateInner(CArchive *ar) const
{	int count = GetCount();
	*ar << count;
		// 
	if(count>1)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawBorder(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	COLORREF clr = GetBorderColor(pCtrl);
	Draw::DrawRect(pDC,pRect,clr);
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	CRect rc(*pRect);
		// 
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawTab(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRgn *pRgn)
{	CRect rc;
	pCtrl->GetTabRect(hTab,&rc);
		// 
		// draw background.
...
// Draw image and text.
// 
void TabCtrlStyle_base::DrawTabContext(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn *pRgn)
{	CRect rcTabPadding = pCtrl->GetTabPadding();
		// 
	CRect rc(pRect);
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawTabImage(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	CImageList *pImageList;
	CSize szImage;
		// 
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawTabText(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	CString text = pCtrl->GetTabText(hTab);
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawButtonClose(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CImageList *pImageList = pCtrl->GetSystemImageList();
	Draw::DrawMarker(pDC,pRect,pImageList,CTabCtrlEx::IMAGE_CLOSE, 
		GetButtonMarkerColor(pCtrl,bHover,bPushed) );
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawButtonMenu(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CImageList *pImageList = pCtrl->GetSystemImageList();
	Draw::DrawMarker(pDC,pRect,pImageList,
		(bPartialView==false ? CTabCtrlEx::IMAGE_MENU : CTabCtrlEx::IMAGE_MENU_PARTIAL),
		GetButtonMarkerColor(pCtrl,bHover,bPushed) );
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawButtonScrollLeft(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CImageList *pImageList = pCtrl->GetSystemImageList();
	Draw::DrawMarker(pDC,pRect,pImageList,
		(bPartialView==false ? CTabCtrlEx::IMAGE_ARROW_LEFT_DISABLE : CTabCtrlEx::IMAGE_ARROW_LEFT),
		GetButtonMarkerColor(pCtrl,bHover,bPushed) );
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_base::DrawButtonScrollRight(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CImageList *pImageList = pCtrl->GetSystemImageList();
	Draw::DrawMarker(pDC,pRect,pImageList,
		(bPartialView==false ? CTabCtrlEx::IMAGE_ARROW_RIGHT_DISABLE : CTabCtrlEx::IMAGE_ARROW_RIGHT),
		GetButtonMarkerColor(pCtrl,bHover,bPushed) );
}
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_base::GetBorderColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_BTNSHADOW);
}
// 
COLORREF TabCtrlStyle_base::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_BTNSHADOW);
}
// 
COLORREF TabCtrlStyle_base::GetCtrlAreaBackColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_BTNFACE);
}
// 
COLORREF TabCtrlStyle_base::GetWndsAreaBackColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_BTNFACE);
}
// 
COLORREF TabCtrlStyle_base::GetTabSelectedBackColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_WINDOW);
}
// 
COLORREF TabCtrlStyle_base::GetTabTextColor(CTabCtrlEx *pCtrl, HTAB hTab)
{	return (pCtrl->IsDisable(hTab)==false ? ::GetSysColor(COLOR_BTNTEXT) : ::GetSysColor(COLOR_GRAYTEXT));
}
// 
COLORREF TabCtrlStyle_base::GetButtonMarkerColor(CTabCtrlEx *pCtrl, bool /*bHover*/, bool /*bPushed*/)
{	return (pCtrl->GetSel()!=NULL ? ::GetSysColor(COLOR_BTNTEXT) : ::GetSysColor(COLOR_GRAYTEXT));
}
// 
COLORREF TabCtrlStyle_base::GetChildWndBackColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_WINDOW);
}
// 
COLORREF TabCtrlStyle_base::GetEmptyWndsAreaBackColor(CTabCtrlEx * /*pCtrl*/)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2003_base::DrawButtonClose(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CRect rc(pRect);
	if(bHover==true && bPushed==true) rc.OffsetRect(1,1);
		// 
	CImageList *pImageList = pCtrl->GetSystemImageList();
	Draw::DrawMarker(pDC,&rc,pImageList,CTabCtrlEx::IMAGE_CLOSE, 
		GetButtonMarkerColor(pCtrl,bHover,bPushed) );
}
// 
void TabCtrlStyle_VS2003_base::DrawButtonMenu(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CRect rc(pRect);
	if(bHover==true && bPushed==true) rc.OffsetRect(1,1);
...
// 
void TabCtrlStyle_VS2003_base::DrawButtonScrollLeft(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CRect rc(pRect);
	if(bHover==true && bPushed==true) rc.OffsetRect(1,1);
...
// 
void TabCtrlStyle_VS2003_base::DrawButtonScrollRight(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
		// 
	CRect rc(pRect);
	if(bHover==true && bPushed==true) rc.OffsetRect(1,1);
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2003_base::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2003_base::GetCtrlAreaBackColor(CTabCtrlEx * /*pCtrl*/)
...
// 
COLORREF TabCtrlStyle_VS2003_base::GetTabTextColor(CTabCtrlEx *pCtrl, HTAB hTab)
{	if(pCtrl->GetSel()==hTab)
...
// 
COLORREF TabCtrlStyle_VS2003_base::GetButtonMarkerColor(CTabCtrlEx *pCtrl, bool bHover, bool bPushed)
...
/////////////////////////////////////////////////////////////////////////////
// 
CRect TabCtrlStyle_VS2003_client::GetCtrlAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(5,2,3,0) : CRect(5,0,3,2));
}
// 
CRect TabCtrlStyle_VS2003_client::GetWndsAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
...
// 
CRect TabCtrlStyle_VS2003_client::GetTabPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? 
		CRect(6,1/*border*/+2,6,2+1/*line*/) : CRect(6,1/*line*/+2,6,2+1/*border*/));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2003_client::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
...
// 
void TabCtrlStyle_VS2003_client::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
...
// 
void TabCtrlStyle_VS2003_client::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	if(pCtrl->GetCount()==0 || pCtrl->GetSel()==NULL)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2003_client::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2003_client_custom1::DrawButtonClose(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	TabCtrlStyle_base::DrawButtonClose(pCtrl,pDC,pRect,bHover,bPushed);
}
// 
void TabCtrlStyle_VS2003_client_custom1::DrawButtonMenu(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	TabCtrlStyle_base::DrawButtonMenu(pCtrl,pDC,pRect,bHover,bPushed,bPartialView);
}
// 
void TabCtrlStyle_VS2003_client_custom1::DrawButtonScrollLeft(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	TabCtrlStyle_base::DrawButtonScrollLeft(pCtrl,pDC,pRect,bHover,bPushed,bPartialView);
}
// 
void TabCtrlStyle_VS2003_client_custom1::DrawButtonScrollRight(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	TabCtrlStyle_base::DrawButtonScrollRight(pCtrl,pDC,pRect,bHover,bPushed,bPartialView);
}
// 
void TabCtrlStyle_VS2003_client_custom1::DrawButtonFrame(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
...
/////////////////////////////////////////////////////////////////////////////
// 
int TabCtrlStyle_VS2003_bars::GetBorderWidth(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return 0;
}
// 
CRect TabCtrlStyle_VS2003_bars::GetCtrlAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(5,2,3,2) : CRect(5,2,3,2));
}
// 
CRect TabCtrlStyle_VS2003_bars::GetTabPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? 
		CRect(6,1/*border*/+1,6,1+1/*line*/) : CRect(6,1/*line*/+1,6,1+1/*border*/));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2003_bars::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	CRect rc(pRect);
...
// 
void TabCtrlStyle_VS2003_bars::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
	bool select = (pCtrl->GetSel()==hTab);
		// 
	CRect rc(pRect);
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2003_bars::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_BTNTEXT);
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// 
CRect TabCtrlStyle_VS2003_bars_custom1::GetCtrlAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(4,1,2,0) : CRect(4,0,2,1));
}
// 
CRect TabCtrlStyle_VS2003_bars_custom1::GetWndsAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	bool bHideSingleTab = (pCtrl->GetCount()==1 && pCtrl->IsHideSingleTab()==true);
	if(bHideSingleTab==false)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2003_bars_custom1::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	CRect rc(pRect);
	COLORREF clrBorder = GetTabBorderColor(pCtrl);
...
// 
void TabCtrlStyle_VS2003_bars_custom1::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2003_bars_custom1::DrawButtonClose(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	TabCtrlStyle_base::DrawButtonClose(pCtrl,pDC,pRect,bHover,bPushed);
}
// 
void TabCtrlStyle_VS2003_bars_custom1::DrawButtonMenu(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	TabCtrlStyle_base::DrawButtonMenu(pCtrl,pDC,pRect,bHover,bPushed,bPartialView);
}
// 
void TabCtrlStyle_VS2003_bars_custom1::DrawButtonScrollLeft(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	TabCtrlStyle_base::DrawButtonScrollLeft(pCtrl,pDC,pRect,bHover,bPushed,bPartialView);
}
// 
void TabCtrlStyle_VS2003_bars_custom1::DrawButtonScrollRight(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed, bool bPartialView)
{	TabCtrlStyle_base::DrawButtonScrollRight(pCtrl,pDC,pRect,bHover,bPushed,bPartialView);
}
// 
void TabCtrlStyle_VS2003_bars_custom1::DrawButtonFrame(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	TabCtrlStyle_base::DrawButtonFrame(pCtrl,pDC,pRect,bHover,bPushed);
}
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2003_bars_custom1::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/)
{	return ::GetSysColor(COLOR_BTNSHADOW);
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// 
int TabCtrlStyle_VS2008_client_base::GetBorderWidth(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return 0;
}
// 
CRect TabCtrlStyle_VS2008_client_base::GetCtrlAreaPadding(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(0,0,3,0);
}
CRect TabCtrlStyle_VS2008_client_base::GetWndsAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	bool bHideSingleTab = (pCtrl->GetCount()==1 && pCtrl->IsHideSingleTab()==true);
	if(bHideSingleTab==false)
...
// 
CRect TabCtrlStyle_VS2008_client_base::GetTabPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(6,1/*border*/+2,6,3+2/*indent*/) : CRect(6,2/*indent*/+2,6,3+1/*border*/));
}
int TabCtrlStyle_VS2008_client_base::GetTabExtraWidth(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/, HTAB hTab)
{	if(pCtrl->GetIndex(hTab)!=0) return 0;	// it isn't first tab.
	return GetSlantWidth(pCtrl) - 6;
}
int TabCtrlStyle_VS2008_client_base::GetTabMinWidth(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetTabMinWidth(pCtrl,base) + (GetSlantWidth(pCtrl)-6);
}
/////////////////////////////////////////////////////////////////////////////
// 
bool TabCtrlStyle_VS2008_client_base::IsStraightOrder(CTabCtrlEx * /*pCtrl*/)
{	return false;
}
// 
void TabCtrlStyle_VS2008_client_base::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
...
// 
void TabCtrlStyle_VS2008_client_base::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn *pRgn)
...
// 
void TabCtrlStyle_VS2008_client_base::DrawTabContext(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn *pRgn)
{	CRect rc(pRect);
	if(pCtrl->GetSel()!=hTab)
...
// 
void TabCtrlStyle_VS2008_client_base::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	int count = pCtrl->GetCount();
		// 
	if(count==0 || pCtrl->GetSel()==NULL)
		TabCtrlStyle_base::DrawWndsAreaBack(pCtrl,pDC,pRect);
...
/////////////////////////////////////////////////////////////////////////////
// 
HTAB TabCtrlStyle_VS2008_client_base::HitTest(CTabCtrlEx *pCtrl, ITabCtrlBehavior * /*base*/, CPoint point)	// get tab in the given point.
{	if(CRect(pCtrl->GetTabsArea()).PtInRect(point)!=0)
	{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
			// 
...
// 
bool TabCtrlStyle_VS2008_client_base::HitTest(CTabCtrlEx *pCtrl, HTAB hTab, bool top, CPoint point) const
{	CRect rc;
	POINT pts[8];
	pCtrl->GetTabRect(hTab,&rc);
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_client_base::GetTabOutline(CTabCtrlEx *pCtrl, HTAB hTab, CRect const *rect, bool top, POINT pts[8]/*out*/, RECT *rcFill/*out*/) const
...
/////////////////////////////////////////////////////////////////////////////
// 
int TabCtrlStyle_VS2008_client_base::GetSlantWidth(CTabCtrlEx *pCtrl) const
...
COLORREF TabCtrlStyle_VS2008_client_classic::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool /*active*/, bool /*disable*/)
{	return ::GetSysColor(COLOR_BTNSHADOW);
}
COLORREF TabCtrlStyle_VS2008_client_classic::GetTabOutlineColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable, bool /*left*/)
...
COLORREF TabCtrlStyle_VS2008_client_classic::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
{	if(active==true) return ::GetSysColor(COLOR_BTNHIGHLIGHT);
	if(hover==true && disable==false) return ::GetSysColor(COLOR_BTNHIGHLIGHT);
	return ::GetSysColor(COLOR_BTNFACE);
}
COLORREF TabCtrlStyle_VS2008_client_classic::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_client_blue::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool active, bool disable)
{	if(active==true) return RGB(105,161,191);
	if(disable==true) return RGB(145,150,162);
	return RGB(145,150,162);
}
COLORREF TabCtrlStyle_VS2008_client_blue::GetTabOutlineColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable, bool left)
...
COLORREF TabCtrlStyle_VS2008_client_blue::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
...
COLORREF TabCtrlStyle_VS2008_client_blue::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_client_silver::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool active, bool disable)
{	if(active==true) return RGB(147,145,176);
	if(disable==true) return RGB(157,157,161);
	return RGB(157,157,161);
}
COLORREF TabCtrlStyle_VS2008_client_silver::GetTabOutlineColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable, bool left)
{	if(active==true) return RGB(255,255,255);
	if(hover==true && disable==false) return RGB(255,255,255);
	if(disable==true) return RGB(172,171,196);
	return (left==true ? RGB(255,255,255) : RGB(172,171,196));
}
COLORREF TabCtrlStyle_VS2008_client_silver::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
...
COLORREF TabCtrlStyle_VS2008_client_silver::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_client_silver::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_client_olive::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool active, bool disable)
{	if(active==true) return RGB(147,160,112);
	if(disable==true) return RGB(172,168,153);
	return RGB(172,168,153);
}
COLORREF TabCtrlStyle_VS2008_client_olive::GetTabOutlineColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable, bool left)
{	if(active==true) return RGB(255,255,255);
	if(hover==true && disable==false) return RGB(255,255,255);
	if(disable==true) return RGB(165,179,133);
	return (left==true ? RGB(255,255,255) : RGB(165,179,133));
}
COLORREF TabCtrlStyle_VS2008_client_olive::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
...
COLORREF TabCtrlStyle_VS2008_client_olive::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool active, bool hover, bool disable)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_client_olive::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed)
	{	Draw::FillSolidRect(pDC,pRect,RGB(255,227,173));
...
/////////////////////////////////////////////////////////////////////////////
// 
int TabCtrlStyle_VS2008_bars_base::GetBorderWidth(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return 0;
}
// 
CRect TabCtrlStyle_VS2008_bars_base::GetCtrlAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(0,1,0,2) : CRect(0,2,0,1));
}
// 
CRect TabCtrlStyle_VS2008_bars_base::GetTabPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? 
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_bars_base::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	Draw::FillSolidRect(pDC,pRect, GetCtrlAreaBackColor(pCtrl) );
		// 
...
// 
void TabCtrlStyle_VS2008_bars_base::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
	bool select = (pCtrl->GetSel()==hTab);
	int count = pCtrl->GetCount();
		// 
...
// 
void TabCtrlStyle_VS2008_bars_base::DrawTabContext(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn *pRgn)
{	CRect rc(pRect);
	if(pCtrl->GetSel()==hTab)
		(pCtrl->GetLayout()==TAB_LAYOUT_TOP ? rc.top-=2 : rc.bottom+=2);
	TabCtrlStyle_base::DrawTabContext(pCtrl,pDC,hTab,&rc,pRgn);
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_base::GetTabTextColor(CTabCtrlEx *pCtrl, HTAB hTab)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_classic::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? ::GetSysColor(COLOR_3DDKSHADOW) : ::GetSysColor(COLOR_BTNSHADOW));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_classic::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool /*hover*/, bool /*disable*/)
{	return ::GetSysColor(COLOR_WINDOW);
}
// 
COLORREF TabCtrlStyle_VS2008_bars_classic::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_blue::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? RGB(60,127,177) : RGB(137,140,149));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_blue::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(250,253,254) : RGB(252,252,252));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_blue::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_silver::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? RGB(119,119,146) : RGB(137,140,149));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_silver::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(247,247,253) : RGB(252,252,252));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_silver::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(180,179,202) : RGB(207,207,207));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_bars_silver::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed)
	{	Draw::FillSolidRect(pDC,pRect,RGB(255,227,173));
		Draw::DrawRect(pDC,pRect,RGB(74,73,107));
	}
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_olive::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? RGB(143,158,116) : RGB(137,140,149));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_olive::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(250,251,247) : RGB(252,252,252));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_olive::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(182,198,141) : RGB(207,207,207));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_bars_olive::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed)
	{	Draw::FillSolidRect(pDC,pRect,RGB(255,227,173));
		Draw::DrawRect(pDC,pRect,RGB(118,128,95));
	}
...
/////////////////////////////////////////////////////////////////////////////
// 
CRect TabCtrlStyle_VS2008_bars_custom1_base::GetCtrlAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(0,1,0,0) : CRect(0,0,0,1));
}
// 
CRect TabCtrlStyle_VS2008_bars_custom1_base::GetWndsAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	bool bHideSingleTab = (pCtrl->GetCount()==1 && pCtrl->IsHideSingleTab()==true);
	if(bHideSingleTab==false)
		return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? CRect(1,0,1,1) : CRect(1,1,1,0));
	else
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_bars_custom1_base::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	Draw::FillSolidRect(pDC,pRect, GetCtrlAreaBackColor(pCtrl) );
		// 
	COLORREF clrBorder = GetTabBorderColor(pCtrl,false);
		// 
...
// 
void TabCtrlStyle_VS2008_bars_custom1_base::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	int count = pCtrl->GetCount();
		// 
	if(count==0 || pCtrl->GetSel()==NULL)
		TabCtrlStyle_base::DrawWndsAreaBack(pCtrl,pDC,pRect);
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_classic_custom1::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? ::GetSysColor(COLOR_3DDKSHADOW) : ::GetSysColor(COLOR_BTNSHADOW));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_classic_custom1::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool /*hover*/, bool /*disable*/)
{	return ::GetSysColor(COLOR_WINDOW);
}
// 
COLORREF TabCtrlStyle_VS2008_bars_classic_custom1::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? 
		Draw::PixelAlpha(::GetSysColor(COLOR_BTNSHADOW),RGB(255,255,255),75) :
		Draw::PixelAlpha(::GetSysColor(COLOR_BTNSHADOW),RGB(255,255,255),55));
}
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_blue_custom1::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? RGB(60,127,177) : RGB(137,140,149));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_blue_custom1::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(250,253,254) : RGB(252,252,252));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_blue_custom1::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(167,217,245) : RGB(207,207,207));
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_silver_custom1::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? RGB(119,119,146) : RGB(137,140,149));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_silver_custom1::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(247,247,253) : RGB(252,252,252));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_silver_custom1::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(180,179,202) : RGB(207,207,207));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_bars_silver_custom1::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed)
	{	Draw::FillSolidRect(pDC,pRect,RGB(255,227,173));
		Draw::DrawRect(pDC,pRect,RGB(74,73,107));
	}
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2008_bars_olive_custom1::GetTabBorderColor(CTabCtrlEx * /*pCtrl*/, bool hover)
{	return (hover==true ? RGB(143,158,116) : RGB(137,140,149));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_olive_custom1::GetTabGradientLightColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(250,251,247) : RGB(252,252,252));
}
// 
COLORREF TabCtrlStyle_VS2008_bars_olive_custom1::GetTabGradientDarkColor(CTabCtrlEx * /*pCtrl*/, bool hover, bool disable)
{	return ((hover==true && disable==false) ? RGB(182,198,141) : RGB(207,207,207));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2008_bars_olive_custom1::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed)
	{	Draw::FillSolidRect(pDC,pRect,RGB(255,227,173));
		Draw::DrawRect(pDC,pRect,RGB(118,128,95));
	}
...
/////////////////////////////////////////////////////////////////////////////
// 
int TabCtrlStyle_VS2010_client::GetBorderWidth(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return 0;
}
// 
CRect TabCtrlStyle_VS2010_client::GetCtrlAreaPadding(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(0,0,3,0);
}
// 
CRect TabCtrlStyle_VS2010_client::GetWndsAreaPadding(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(0,4,0,4);
}
// 
CRect TabCtrlStyle_VS2010_client::GetTabPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? 
		CRect(5,1/*border*/+3,5,3) : CRect(5,3,5,3+1/*border*/));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2010_client::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	Draw::FillSolidRect(pDC,pRect,GetCtrlAreaBackColor(pCtrl));
}
// 
void TabCtrlStyle_VS2010_client::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	if(pCtrl->IsDisable(hTab)==false)
...
// 
void TabCtrlStyle_VS2010_client::DrawTabBack(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool top, bool active, bool select, bool hover)
{	CRect rc(pRect);
		// 
	if(top==true)
	{	if(select==true)
...
// 
void TabCtrlStyle_VS2010_client::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	if(pCtrl->GetCount()==0 || pCtrl->GetSel()==NULL)
		TabCtrlStyle_base::DrawWndsAreaBack(pCtrl,pDC,pRect);
	else
	{	bool active = pCtrl->IsActive();
...
// 
void TabCtrlStyle_VS2010_client::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect, bool top, bool active)
{	CRect rc;
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2010_client::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2010_client::GetCtrlAreaBackColor(CTabCtrlEx * /*pCtrl*/)
{	return RGB(46,64,94);
}
// 
COLORREF TabCtrlStyle_VS2010_client::GetTabTextColor(CTabCtrlEx *pCtrl, HTAB hTab)
{	return (pCtrl->GetSel()==hTab ? RGB(13,0,5) : RGB(248,255,255));
}
// 
COLORREF TabCtrlStyle_VS2010_client::GetEmptyWndsAreaBackColor(CTabCtrlEx * /*pCtrl*/)
{	return RGB(46,64,94);
}
// 
COLORREF TabCtrlStyle_VS2010_client::GetButtonMarkerColor(CTabCtrlEx * /*pCtrl*/, bool bHover, bool bPushed)
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2010_client_custom1::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	if(pCtrl->IsDisable(hTab)==false)
	{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
		bool select = (pCtrl->GetSel()==hTab);
		bool hover = (pCtrl->GetHover()==hTab);
...
// 
void TabCtrlStyle_VS2010_client_custom1::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	if(pCtrl->GetCount()==0 || pCtrl->GetSel()==NULL)
		TabCtrlStyle_base::DrawWndsAreaBack(pCtrl,pDC,pRect);
	else
	{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2010_client_custom2::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	if(pCtrl->IsDisable(hTab)==false)
	{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
		bool select = (pCtrl->GetSel()==hTab);
		bool hover = (pCtrl->GetHover()==hTab);
...
// 
void TabCtrlStyle_VS2010_client_custom2::DrawWndsAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	if(pCtrl->GetCount()==0 || pCtrl->GetSel()==NULL)
		TabCtrlStyle_base::DrawWndsAreaBack(pCtrl,pDC,pRect);
	else
	{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
...
/////////////////////////////////////////////////////////////////////////////
// 
int TabCtrlStyle_VS2010_bars::GetBorderWidth(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return 0;
}
// 
CRect TabCtrlStyle_VS2010_bars::GetCtrlAreaPadding(CTabCtrlEx * /*pCtrl*/, ITabCtrlRecalc * /*base*/)
{	return CRect(0,0,3,0);
}
// 
CRect TabCtrlStyle_VS2010_bars::GetTabPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc * /*base*/)
{	return (pCtrl->GetLayout()==TAB_LAYOUT_TOP ? 
		CRect(5,1/*border*/+1,5,2) : CRect(5,2,5,1+1/*border*/));
}
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2010_bars::DrawCtrlAreaBack(CTabCtrlEx *pCtrl, CDC *pDC, CRect const *pRect)
{	Draw::FillSolidRect(pDC,pRect,GetCtrlAreaBackColor(pCtrl));
}
// 
void TabCtrlStyle_VS2010_bars::DrawTabBack(CTabCtrlEx *pCtrl, CDC *pDC, HTAB hTab, CRect const *pRect, CRgn * /*pRgn*/)
{	if(pCtrl->IsDisable(hTab)==false)
	{	bool top = (pCtrl->GetLayout()==TAB_LAYOUT_TOP);
		bool select = (pCtrl->GetSel()==hTab);
		bool hover = (pCtrl->GetHover()==hTab);
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrlStyle_VS2010_bars::DrawButtonFrame(CTabCtrlEx * /*pCtrl*/, CDC *pDC, CRect const *pRect, bool bHover, bool bPushed)
{	if(bHover!=bPushed || (bHover==true && bPushed==true))
	{	CRect rc(pRect);
		Draw::DrawRect(pDC,&rc,RGB(229,195,101));
			// 
...
/////////////////////////////////////////////////////////////////////////////
// 
COLORREF TabCtrlStyle_VS2010_bars::GetCtrlAreaBackColor(CTabCtrlEx * /*pCtrl*/)
{	return RGB(46,64,94);
}
// 
COLORREF TabCtrlStyle_VS2010_bars::GetTabTextColor(CTabCtrlEx *pCtrl, HTAB hTab)
{	return (pCtrl->GetSel()==hTab ? RGB(13,0,5) : RGB(248,255,255));
}
// 
COLORREF TabCtrlStyle_VS2010_bars::GetEmptyWndsAreaBackColor(CTabCtrlEx * /*pCtrl*/)
{	return RGB(46,64,94);
}
// 
COLORREF TabCtrlStyle_VS2010_bars::GetButtonMarkerColor(CTabCtrlEx * /*pCtrl*/, bool bHover, bool bPushed)
{	return ((bHover==true || bPushed==true) ? RGB(0,0,0) : RGB(206,212,221));
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// 
int TabCtrlRecalcStub::GetBorderWidth(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetBorderWidth(pCtrl,NULL);
}
	// 
CRect TabCtrlRecalcStub::GetCtrlAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetCtrlAreaPadding(pCtrl,NULL);
}
CRect TabCtrlRecalcStub::GetWndsAreaPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetWndsAreaPadding(pCtrl,NULL);
}
	// 
CRect TabCtrlRecalcStub::GetTabHorzMargin(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetTabHorzMargin(pCtrl,NULL);
}
CRect TabCtrlRecalcStub::GetTabPadding(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetTabPadding(pCtrl,NULL);
}
int TabCtrlRecalcStub::GetTabImageTextGap(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)	// IMAGE<- gap ->TEXT.
{	return base->GetTabImageTextGap(pCtrl,NULL);
}
int TabCtrlRecalcStub::GetTabExtraWidth(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base, HTAB hTab)
{	return base->GetTabExtraWidth(pCtrl,NULL,hTab);
}
int TabCtrlRecalcStub::GetTabMinWidth(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetTabMinWidth(pCtrl,NULL);
}
	// 
CRect TabCtrlRecalcStub::GetLeftScrollButtonHorzMargin(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetLeftScrollButtonHorzMargin(pCtrl,NULL);
}
CRect TabCtrlRecalcStub::GetRightScrollButtonHorzMargin(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetRightScrollButtonHorzMargin(pCtrl,NULL);
}
CRect TabCtrlRecalcStub::GetMenuButtonHorzMargin(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
{	return base->GetMenuButtonHorzMargin(pCtrl,NULL);
}
CRect TabCtrlRecalcStub::GetCloseButtonHorzMargin(CTabCtrlEx *pCtrl, ITabCtrlRecalc *base)
...
/////////////////////////////////////////////////////////////////////////////
// 
HTAB TabCtrlBehaviorStub::HitTest(CTabCtrlEx *pCtrl, ITabCtrlBehavior *base, CPoint point)
{	return base->HitTest(pCtrl,NULL,point);
}
// 
bool TabCtrlBehaviorStub::SetCursor(CTabCtrlEx *pCtrl, ITabCtrlBehavior *base)
