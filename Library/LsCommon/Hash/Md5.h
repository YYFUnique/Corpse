...
/* MD5 Class. */
class LS_COMMON_API CMD5: public CHash 
{
public:
	CMD5();
private:
...
public:
//==================================================================
//函 数 名: GetMd5ByFileName
//功    能: 通过文件名获取MD5
//输入参数: IN LPCTSTR lpcszName,传入文件名
//			IN DWORD dwSize, 存放MD5字符串的数组大小
//			OUT LPTSTR szMd5, MD5字符串输出地址
//返 回 值: 返回MD5字符串
//==================================================================
	LPCTSTR GetMd5ByFileName(IN LPCTSTR lpcszFileName, IN DWORD dwSize, OUT LPTSTR szMd5);
