...
CFileNotifyInformation::CFileNotifyInformation(BYTE * lpFileNotifyInfoBuffer, DWORD dwBuffSize)
...
{
	if( m_pCurrentRecord &&	m_pCurrentRecord->NextEntryOffset != 0UL)//is there another record after this one?
	{
