...
#include <math.h>
#include "easing.h"
#include "UISDK/Kernel/Inc/Interface/ianimatedef.h"
...
AHFloat Easing(long/*EaseType*/ eType, AHFloat p)
{
    ...
    case UI::ease_in_quad:
        return QuadraticEaseIn(p);
    case UI::ease_out_quad:
        return QuadraticEaseOut(p);
    case UI::ease_in_out_quad:
    ...
    case UI::ease_in_quart:
        return QuarticEaseIn(p);
    case UI::ease_out_quart:
        return QuarticEaseOut(p);
    case UI::ease_in_out_quart:
        return QuarticEaseInOut(p);

    case UI::ease_in_quint:
        return QuinticEaseIn(p);
    case UI::ease_out_quint:
        return QuinticEaseOut(p);
    case UI::ease_in_out_quint:
        return QuinticEaseInOut(p);

    case UI::ease_in_sine:
        return SineEaseIn(p);
    case UI::ease_out_sine:
        return SineEaseOut(p);
    case UI::ease_in_out_sine:
        return SineEaseInOut(p);

    case UI::ease_in_circ:
        return CircularEaseIn(p);
    case UI::ease_out_circ:
        return CircularEaseOut(p);
    case UI::ease_in_out_circ:
        return CircularEaseInOut(p);
    
    case UI::ease_in_expo:
        return ExponentialEaseIn(p);
    case UI::ease_out_expo:
        return ExponentialEaseOut(p);
    case UI::ease_in_out_expo:
        return ExponentialEaseInOut(p);

    case UI::ease_in_back:
        return BackEaseIn(p);
    case UI::ease_out_back:
        return BackEaseOut(p);
    case UI::ease_in_out_back:
        return BackEaseInOut(p);

    case UI::ease_in_elastic:
        return ElasticEaseIn(p);
    case UI::ease_out_elastic:
        return ElasticEaseOut(p);
    case UI::ease_in_out_elastic:
        return ElasticEaseInOut(p);

    case UI::ease_in_bounce:
        return BounceEaseIn(p);
    case UI::ease_out_bounce:
        return BounceEaseOut(p);
    case UI::ease_in_out_bounce:
