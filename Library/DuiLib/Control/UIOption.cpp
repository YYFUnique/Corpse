...
namespace DuiLib
{
	...
	LPCTSTR COptionUI::GetSelectedPressImage()
	{
		return m_sSelectedPressImage;
	}

	void COptionUI::SetSelectedPressImage(LPCTSTR pStrImage)
	{
		m_sSelectedPressImage = pStrImage;
		Invalidate();
	}
	...
	void COptionUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if( _tcscmp(pstrName, _T("selectedpressimage")) == 0 ) SetSelectedPressImage(pstrValue);
