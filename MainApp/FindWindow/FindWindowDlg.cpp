...
BOOL CFindWindowDlg::PreTranslateMessage(MSG* pMsg)
{
	if (pMsg->hwnd == m_hWnd)
		OutputDebugString(DUI__TraceMsg(pMsg->message));
...
void CFindWindowDlg::OnSyncPaint()
{

}

/*void CFindWindowDlg::OnPaintClient()*/
